package com.crossover.trial.awa.weather.client;
...
public class WeatherClient {
    ...
    private static final String BASE_URI = "http://localhost:8080"; // CR: Should be initialized via constructor
    // CR: Also, another variable TARGET_URI is needed.
    ...
    public void populate() { // CR: Something wrong with this method. 
        WebTarget path = collect.path("/weather/BOS/wind");
        DataPoint dp = null;
		try {
			dp = DataPointBuilder.build("wind", 0, 4, 10, 4, 10);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} // CR: Better to use singleton pattern.
        path.request().post(Entity.entity(dp, "application/json")); // CR: This variable was never used.
    }
