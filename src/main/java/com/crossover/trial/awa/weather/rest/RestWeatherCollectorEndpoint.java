...
public class RestWeatherCollectorEndpoint implements WeatherCollector {
	...
	public Response updateWeather(@PathParam("iata") String iataCode,
		...
		try {
			Airport airport = airportDataManager.get(iataCode);
			AtmosphericInformation info = airport.getInfo();
	...
	public void updateAtmosphericInformation(AtmosphericInformation ai, DataPoint dp) throws Exception {
		Thread t = new Thread(new AtmosphericInformationUpdater(ai, dp));
		t.start();
		airportDataManager.addRequest(RequestType.UPDATE, System.currentTimeMillis());
	}
